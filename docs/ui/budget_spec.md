...
| Budget selection             | Selection is driven entirely by mutations and query invalidation.                                                              | Backend has select/unselect endpoints and validates candidates; only validated quotes and DIY estimates can be selected. Any number of quotes and DIY estimates can be selected simultaneously per budget line; there is no cap. | There is no local selection state; the backend is the source of truth.                                                                                                         |
